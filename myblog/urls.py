...
from .views import HomeView, ArticleView, CreatePost, UpdatePost, DeletePost, CategoryView
...
urlpatterns = [
    ...
    path("category-detail/<int:pk>", CategoryView.as_view(), name="category-detail")
]
